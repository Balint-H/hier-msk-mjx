...
def main(argv):
  ...
  registry.locomotion.register_environment("MyoHand", MjxHand, default_config)
  ...
  training_params["ll_optimizer"] = optax.sgd(learning_rate=env_cfg.rl_config.ll_learning_config.learning_rate)
  if env_cfg.rl_config.ll_learning_config.ll_opt_max_grad_norm is not None:
    training_params["ll_optimizer"] = optax.chain(
        ...
        optax.sgd(learning_rate=env_cfg.rl_config.ll_learning_config.learning_rate)
    )
